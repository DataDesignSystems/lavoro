...
class ALChatManager: NSObject {
    ...
    func registerUserAndLaunchChat(_ alUser:ALUser?, fromController:UIViewController,forUser:String?)
    {
        ...
        {
            //chat customizing
            ALApplozicSettings.setBackgroundColorForReplyView(UIColor(hexString: "3650ad"))
            ALApplozicSettings.setColorForNavigation(UIColor(hexString: "3650ad"))
            ALApplozicSettings.setChatWallpaperImageName("")
            ALApplozicSettings.setColorForTypeMsgBackground(UIColor(hexString: "3650ad"))
            //ALApplozicSettings.setBGColorForTypingLabel(UIColor.white)
            ALApplozicSettings.setMsgTextViewBGColor(UIColor.white)
            ALApplozicSettings.setBackgroundColorForAttachmentPlusIcon(UIColor.white)
...
func ALDefaultChatViewSettings ()
{
     ...
     ALUserDefaultsHandler.setUserAuthenticationTypeId(TYPE_CLIENT)
     ////////////////////////// ////////////////////////// ////////////////////////// ///////////////////////

     
     /*********************************************  NAVIGATION SETTINGS  ********************************************/
     
     ALApplozicSettings.setStatusBarBGColor(UIColor.clear)
     ...
     ALApplozicSettings.setColorForNavigation(UIColor(red: 31, green: 163, blue: 92))
     ...
     ALApplozicSettings.setSendMsgTextColor(UIColor.black)
     ALApplozicSettings.setReceiveMsgTextColor(UIColor.black)
     ALApplozicSettings.setColorForReceiveMessages(UIColor.white)
     ALApplozicSettings.setColorForSendMessages(UIColor(red: 135, green: 210, blue: 170))
     
     //****************** DATE COLOUR : AT THE BOTTOM OF MESSAGE BUBBLE ******************/
    
     ALApplozicSettings.setDateColor(UIColor.white)
...
//    #endif
     ...
     let sendButtonColor = UIColor.clear   /*  SET COLOR FOR SEND BUTTON   */
     ALApplozicSettings.setColorForSendButton(sendButtonColor)
    
     ALApplozicSettings.setColorForTypeMsgBackground(UIColor(red: 22, green: 117, blue: 57))            /*  SET COLOR FOR TYPE MESSAGE OUTER VIEW */
     ...
     ALUserDefaultsHandler.setAppModuleName("Stanley Dean")
     /****************************************************************************************************************/
     ...
     ALApplozicSettings.setFontFace("OpenSans")
     ALApplozicSettings.setChatWallpaperImageName("backgroundGradient")
     /****************************************************************************************************************/
